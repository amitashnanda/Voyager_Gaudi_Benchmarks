...
PT_HPU_LAZY_MODE=0 python3 ../gaudi_spawn.py \
    --world_size 6 --use_mpi run_lora_clm.py \
    ...
    --bf16 True \
    --output_dir ./gemma2_27b_lora64_6HPUs_withBoltMonkeyParquet_gaudi2_February20_2026_fsdp \
    --num_train_epochs 1 \
    ...
    --use_lazy_mode False \
    --fsdp_config fsdp_config_gemma2.json \
    --fsdp auto_wrap \
