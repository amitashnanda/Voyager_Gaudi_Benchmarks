#!/usr/bin/env bash
#SBATCH --job-name="sr3_2cards_h100"
#SBATCH --output="out_sr3_2cards_h100.%j.%N.out"
...
time -p singularity exec --bind /home,/expanse,/scratch --nv /expanse/projects/qstore/installs/containers/singularity/Expanse-Air/pytorch/pytorch-nvcr-25.03.sif $WORKDIR/run_sr_2gpu.sh #python3 $SLURM_SUBMIT_DIR/main.py
